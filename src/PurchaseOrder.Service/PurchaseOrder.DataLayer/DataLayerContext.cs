...
namespace PurchaseOrder.DataLayer
{
    public class DataLayerContext :IDataLayerContext
    {
        ...
        public IEnumerable<Pc01> GetPurchaseOrderByCompanyCode(string companyCode)
        {
            ...
            var dicTableName = _configReader.GetDatabaseTableName(companyCode, Constants.ParentCompanyCode, 
            ...
            var lstOfPc01 = dicTableName[Constants.TableNameKey] != dicTableName[Constants.ColumnNameKey] ? 
                            Database.Get<Pc01>(dicTableName[Constants.TableNameKey], dicTableName[Constants.ColumnNameKey]) : null;
        ...
        /// <summary>
        /// Gets the Purchase order details by company code and purchase order number at DAL
        /// </summary>
        /// <param name="companyCode">company code as string</param>
        ...
        public Pc01 GetPurchaseOrderByPurchaseOrderNumber(string companyCode, string purchaseOrderNumber)
        {
            ...
            string query = $"trim(lower({Constants.ColPurchaseOrderNumber})) = '{purchaseOrderNumber.ToLower().Trim()}'";
            var lstOfPc01 = dicTableName[Constants.TableNameKey] != dicTableName[Constants.ColumnNameKey] ? 
        ...
        /// <summary>
        /// Gets the Purchase order details by company code and order type at DAL
        /// </summary>
        /// <param name="companyCode">company code as string</param>
        ...
        public IEnumerable<Pc01> GetPurchaseOrderByOrderType(string companyCode, string orderType)
        {
            ...
            string query = $"trim(lower({Constants.ColOrderType})) = '{orderType.ToLower().Trim()}'";
            var lstOfPc01 = dicTableName[Constants.TableNameKey] != dicTableName[Constants.ColumnNameKey] ? 
                            Database.Where<Pc01>(dicTableName[Constants.TableNameKey], dicTableName[Constants.ColumnNameKey], query) : null;
        ...
        /// <summary>
        /// Gets the Purchase order details by company code and customer name at DAL
        /// </summary>
        /// <param name="companyCode">company code as string</param>
        ...
        public IEnumerable<Pc04> GetPurchaseOrderByCustomerName(string companyCode, string customerName)
        {
            ...
            var dicPc01TableDetails = _configReader.GetDatabaseTableName(companyCode, Constants.ParentCompanyCode, 
                                        Constants.DatalakePc01TableNameKey, Constants.DatalakePc01ColumnNameKey);
            string purchaseOrderTableName = dicPc01TableDetails[Constants.TableNameKey];
            var dicPc04TableDetails = _configReader.GetDatabaseTableName(companyCode, Constants.ParentCompanyCode, 
                                        Constants.DatalakePc04TableNameKey, Constants.DatalakePc04ColumnNameKey);
        ...
        /// <summary>
        /// Gets the Purchase order details by company code and project number at DAL
        /// </summary>
        /// <param name="companyCode">company code as string</param>
        ...
        public IEnumerable<Pc01> GetPurchaseOrderByProjectNumber(string companyCode, string projectNumber)
        {
            ...
            string query = $"trim(lower({Constants.ColProjectNumber})) = '{projectNumber.ToLower().Trim()}'";
            var lstOfPc01 = dicTableName[Constants.TableNameKey] != dicTableName[Constants.ColumnNameKey] ?
                Database.Where<Pc01>(dicTableName[Constants.TableNameKey], dicTableName[Constants.ColumnNameKey], query) : null;
        ...
        public IEnumerable<Pc01> GetPurchaseOrderByOrderDateRange(string companyCode, string orderStartDate, string orderEndDate)
        {
            ...
            string query = $"TO_DATE({Constants.OrderDate})>='{orderStartDate.ToLower().Trim()}' AND TO_DATE({Constants.OrderDate})<='{orderEndDate.ToLower().Trim()}'";
            var lstOfPc01 = dicTableName[Constants.TableNameKey] != dicTableName[Constants.ColumnNameKey] ?
                Database.Where<Pc01>(dicTableName[Constants.TableNameKey], dicTableName[Constants.ColumnNameKey], query) : null;
        ...
        public IEnumerable<Pc01> GetPurchaseOrderByDeliveryDateRange(string companyCode, string deliveryStartDate, string deliveryEndDate)
        {
            ...
            string query = $"TO_DATE({Constants.DeliveryDate})>='{deliveryStartDate.ToLower().Trim()}' AND TO_DATE({Constants.DeliveryDate})<='{deliveryEndDate.ToLower().Trim()}'";
            var lstOfPc01 = dicTableName[Constants.TableNameKey] != dicTableName[Constants.ColumnNameKey] ?
                Database.Where<Pc01>(dicTableName[Constants.TableNameKey], dicTableName[Constants.ColumnNameKey], query) : null;
