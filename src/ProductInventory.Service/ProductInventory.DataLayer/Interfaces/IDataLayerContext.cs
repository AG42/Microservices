...
namespace ProductInventory.DataLayer.Interfaces
{
    public interface IDataLayerContext
    {
        ...
        List<ItemWarehouse> GetItemWareHouse(string companyCode, string productCode, string locationId);
        /// <summary>
        ...
        List<ItemWarehouse> GetItemWareHouseByProductCode(string companyCode, string productCode); /// <summary>
        /// Gets details from item warehouse by company code and product code.
        /// </summary>
        /// <param name="companyCode">The company code.</param>
        /// <param name="locationId">The location id.</param>
        /// <returns>List of item warehouse</returns>
        List<ItemWarehouse> GetItemWareHouseByLocationId(string companyCode, string locationId);
        /// <summary>
