...
namespace ProductInventory.DataLayer
{
    class ConfigReader
    {
        ...
        private const string DATABASE_CONNECTIONSTRING_KEY = "DatabaseConnectionString";
        ...
        {
            DatabaseConnectionString = ReadConfig(DATABASE_CONNECTIONSTRING_KEY);
        }
        private void InitializeFromDatabase()
        {
            ...
            DatabaseConnectionString = configurationDictionary[DATABASE_CONNECTIONSTRING_KEY];
        }
