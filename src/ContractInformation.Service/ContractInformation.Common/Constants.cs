namespace ContractInformation.Common
{
    public static class Constants
    {
        ...
        public const string CustomerPONumberIsRequiredMessage = "Please enter Customer PO Number";
        public const string RequestNumberIsRequiredMessage = "Please enter request number";
        public const string ServiceContractNumberIsRequiredMessage = "Please enter service contract number";
        public const string StatusIsRequiredMessage = "Please enter status";
        public const string ReferenceIsRequiredMessage = "Please enter reference";
        public const string SearchKeyIsRequired = "Please enter search key";
        public const string DateIsRequired = "Please enter date";
