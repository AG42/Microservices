...
namespace ServiceOrder.UnitTest
{
    ...
    public class DatabaseContextUnitTest
    {
        ...
        {
            _datalakeEntities = MockRepository.GenerateMock<IDatabase>();
        ...
        {
            _datalakeEntities.Stub(x => x.Get<SM01>("tablename", "columnName"))
                .IgnoreArguments()
                .Return(_serviceOrderMasterList);
            var databaseContext = new DatabaseContext() { Database = _datalakeEntities };
        ...
        {
            _datalakeEntities.Stub(x => x.Where<SL01>("tableName", "columnName", "condition"))
                .IgnoreArguments()
        ...
        {
            _datalakeEntities.Stub(x => x.Where<SM01>("tableName", "columnName", "condition"))
                .IgnoreArguments()
                .Return(_serviceOrderMasterList);
            var databaseContext = new DatabaseContext() { Database = _datalakeEntities };
        ...
        {
            _datalakeEntities.Stub(x => x.Where<SM03>("tableName", "columnName", "condition"))
                .IgnoreArguments()
        ...
        {
            _datalakeEntities.Stub(x => x.Where<SM05>("tableName", "columnName", "condition"))
                .IgnoreArguments()
        ...
        {
            _datalakeEntities.Stub(x => x.Where<SM07>("tableName", "columnName", "condition"))
                .IgnoreArguments()
